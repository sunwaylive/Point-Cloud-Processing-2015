...
static GLColor cGray(0.85, 0.85, 0.85);
...
public:
  ...
  void drawPickedPointOriginalNeighbor(CMesh* samples, CMesh* original, vector<int>& pickList);

  void drawPickedDisk(CMesh* dual_samples, NeighborDisk* disk);
